insert into company_tb (id, corporate_name, cnpj, address, county, zip_code, phone, mail, titular_name, cpf)
...
insert into account_chart_tb (id, account_type, aspect,
classification,description,  bank_account_id)
values (1 'physical', 1, 'bank','Another account',  1);

insert into account_chart_tb (id, account_type, aspect,
classification, description,bank_account_id)
values (2,'physical', 2, 'bank','Just another account', 1);


insert into provider_tb (id, address, cnpj_cpf, corporate_name, county, mail, phone, zip_code)
values (1, 'Colorful Street', '24405357000118', 'James Esfirras','Alabama', 'esfirras@corporation.com', '202-555-0119', '09456');

insert into provider_tb (id, address, cnpj_cpf, corporate_name, county, mail, phone, zip_code)
values (2, 'Sunset Street', '91410886000105', 'Pedro Pedrinhas','Bibb',
'pedrinhas@corporation.com', '202-555-0140', '30603');

insert into customer_tb (id, address, cnpj_cpf, corporate_name, county, mail, phone, zip_code)
values (1, 'Live Street', '66981350033', 'Lucas', 'Lumpkin', 'lucas@gmail.com',
'+1-202-555-0130', '83585');

insert into customer_tb (id, address, cnpj_cpf, corporate_name, county, mail, phone, zip_code)
values (2, 'Pop Street', '35725344029', 'Julia', 'Orange', 'julia@outlook.com',
 '+1-202-555-0116', '18113');